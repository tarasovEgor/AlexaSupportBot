...
from .new_client_commands import router as new_client_commands_router
from .form_contract_commands import router as form_contract_commands_router
...
router.include_router(new_client_commands_router)
router.include_router(form_contract_commands_router)
